...
typedef enum {
   SEM_ERRO, REPETIDO, ORDENADA, NAO_ORDENADA, GRAFO_NAO_VALORADO, ESTR_VAZIA, NAO_ENCONTRADO,
   POS_INVALIDA, GAVETA_INV, NAO_INI
} Erro; 
...
typedef void (*gaveta_criador(Gaveta **gaveta));
